...
<head>
    ...
    <title>Online Courses IT Landing Page</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                    ...
                    <li class="nav-item mx-2">
                        <a href="javascript:void(0);" class="btn bg-gradient-dark mb-0 cursor-pointer">
                            Sign Up
                        </a>
                    </li>
                </ul>
        ...
        <div class="container position-relative">
            <div class="row">
                <div class="col-lg-5 d-flex flex-column pt-lg-4 pt-xl-5">
                    <h5 class="mb-2 font-weight-bolder">Courses</h5>
                    <h1 class="display-3 font-weight-bolder mb-4"><span class="text-primary text-gradient">Online Courses</span> <br> for Every Student</h1>
                    <p class="fs-lg mb-5">Over 200 courses to make you an expert in technology. Start now learning using our courses!</p>
                    ...
                    <form class="d-none d-sm-flex mb-5">
                        ...
                        <button class="btn btn-lg btn-primary mb-0" type="button">
                            Search
                        </button>
                    </form>

                    <form class="d-sm-none mb-5">
                        <input type="text" class="form-control form-control-lg mb-2" placeholder="Search...">
                        ...
                        <button class="btn btn-primary w-100 mb-0" type="button">
                            Search
                        </button>
                    </form>
                    <div class="d-flex align-items-center mt-auto mb-3 mb-lg-0 pb-4 pb-lg-0 pb-xl-5">
                        ...
                        <span>Join over <span class="text-primary font-weight-bold">100k</span> students</span>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="mb-5">See Popular Courses</h2>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                            <a href="javascript:;" class="d-block">
                                ...
                                <span class="badge bg-gradient-info mb-3 position-absolute top-10 start-5">Best Seller</span>
                            </a>
                        </div>
                        <div class="card-body pt-3">
                            <a href="javascript:;" class="card-title h5 d-block text-darker font-weight-bolder">
                                From 0 to React Developer
                            </a>
                            <p class="text-dark mb-1">
                                Dive in and learn React.js from scratch! Learn Reactjs, Hooks, Redux, React Routing, Animations, Next.js and way more!
                            </p>
                            <span class="text-sm mb-3">by Mathew Glock</span>
                            <h5 class="font-weight-bolder mt-3">$12.50</h5>
                            <div class="align-items-center">

                                <div class="stats">
                                    <small class="border-end font-weight-bold pe-2">48.5 hours</small>
                                    <small class="font-weight-bold ps-1 pe-2">32 lessons</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb-lg-0 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <p class="text-dark mb-1">
                                Vue.js is an awesome JavaScript Framework for building Frontend Applications. You will learn everything you need.
                            </p>
                            <span class="text-sm mb-3">by Andrew Fiesta (Stanford Teacher)</span>
                            <h5 class="font-weight-bolder mt-3 text-danger">$9.90 <strike class="text-dark ms-1">$19.90</strike></h5>
                            <div class="align-items-center">

                                <div class="stats">
                                    <small class="border-end font-weight-bold pe-2">98.5 hours</small>
                                    <small class="font-weight-bold ps-1 pe-2">44 lessons</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb-lg-0 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <p class="text-dark mb-1">
                                Learn the core Java skills needed to apply for Java developer positions in just 14 hours. It was never easier to become a java developer.
                            </p>
                            <span class="text-sm mb-3">by Jaksan Anthouine</span>
                            <h5 class="font-weight-bolder mt-3">$14.90</h5>
                            <div class="align-items-center">

                                <div class="stats">
                                    <small class="border-end font-weight-bold pe-2">14 hours</small>
                                    <small class="font-weight-bold ps-1 pe-2">16 lessons</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="info">
                        ...
                        <h5 class="mt-2">Find the Right Course</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="info">
                        ...
                        <h5 class="mt-2">Learn &amp; Do Homeworks</h5>
                        <p>We get insulted by others, lose trust for those We get back.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-4">Trusted by the best Companies</h2>
                </div>
            </div>
            <div class="row mt-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-5 mb-lg-0">
                    <h6 class="text-uppercase mb-2">Courses</h6>
                    <p class="mb-4 pb-2">
